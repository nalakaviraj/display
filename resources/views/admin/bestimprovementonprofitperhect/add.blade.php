        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-8 col-md-offset-2">
                        <h1 class="page-header">BEST IMPROVEMENT ON PROFIT PER HECT -
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-offset-2">
                        <h3 class="page-header {{ (Request::is('admin/pro_report/bestimprovementonprofitperhect/add/KVPL')) ?  'link-hightliter':'' }}"> <a href="{{ url('/admin/pro_report/bestimprovementonprofitperhect/add/KVPL') }}">KELANI VALLEY </a>
                        </h3>
                    </div>
                    <div class="col-lg-4">
                        <h3 class="page-header {{ (Request::is('admin/pro_report/bestimprovementonprofitperhect/add/TTEL')) ?  'link-hightliter':'' }}"> <a href="{{ url('/admin/pro_report/bestimprovementonprofitperhect/add/TTEL') }}">TALAWAKELLE</a>
                        </h3>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-offset-2">
                  ...
                  <form method="post" action="{{ url("/admin/pro_report/bestimprovementonprofitperhect/add") }}" >
                    ...
                    <div id="loadDivision"></div>
                      ...
                      <table class="table table-condensed">
                          ...
                          <body>
                            @foreach ($bestimprovementonprofitperhect as $value)

                              <tr>
                                <form action="{{ url('/admin/pro_report/bestimprovementonprofitperhect/delete') }}" method="post" >
