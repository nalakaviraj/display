    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-offset-2">
                <h1 class="page-header">BEST IMPROVEMENT IN RANK TEA FACTORIES -
                    <small>ESTATE</small>
                </h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-offset-2">
                <h3 class="page-header {{ (Request::is('admin/pro_report/bestimprovementinrankteafactory/add/KVPL')) ?  'link-hightliter':'' }}"> <a href="{{ url('/admin/pro_report/bestimprovementinrankteafactory/add/KVPL') }}">KELANI VALLEY </a>
                </h3>
            </div>
            <div class="col-lg-4">
                <h3 class="page-header {{ (Request::is('admin/pro_report/bestimprovementinrankteafactory/add/TTEL')) ?  'link-hightliter':'' }}"> <a href="{{ url('/admin/pro_report/bestimprovementinrankteafactory/add/TTEL') }}">TALAWAKELLE</a>
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-offset-2">
                ...
                <form method="post" action="{{ url("/admin/pro_report/bestimprovementinrankteafactory/add") }}" >
                ...
                <table class="table table-condensed">
                          ...
                          <body>
                            @foreach ($bestimprovementinrankteafactory as $value)
                              <tr>
                                <form action="{{ url('/admin/pro_report/bestimprovementinrankteafactory/delete') }}" method="post" >
