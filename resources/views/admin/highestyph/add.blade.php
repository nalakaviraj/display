        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-8 col-md-offset-2">
                        <h1 class="page-header">HIGHEST YPH -
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-offset-2">
                        <h3 class="page-header {{ (Request::is('admin/pro_report/highestyph/add/KVPL')) ?  'link-hightliter':'' }}"> <a href="{{ url('/admin/pro_report/highestyph/add/KVPL') }}">KELANI VALLEY </a>
                        </h3>
                    </div>
                    <div class="col-lg-4">
                        <h3 class="page-header {{ (Request::is('admin/pro_report/highestyph/add/TTEL')) ?  'link-hightliter':'' }}"> <a href="{{ url('/admin/pro_report/highestyph/add/TTEL') }}">TALAWAKELLE</a>
                        </h3>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-offset-2">
                  ...
                  <form method="post" action="{{ url("/admin/pro_report/highestyph/add") }}" >
                    ...
                    <div id="loadDivision"></div>
                      ...
                      <table class="table table-condensed">
                          ...
                          <body>
                            @foreach ($highestyph as $value)
                                    
                              <tr>
                                <form action="{{ url('/admin/pro_report/highestyph/delete') }}" method="post" >
