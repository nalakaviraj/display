...
//                            exit();
                        ?>
                        <form action="{{ route('update_rss') }}" class="horizantal-forms" method="post">
                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                            <input type="hidden" name="id" value="{{ $rss->id }}">
                            <div class="form-group">
                                <label class="control-label">News</label>
                                <textarea  onkeyup="charactor_count()" rows="2" name="news" id="news" class="form-control">{{ $rss->news }}</textarea>
                            </div>
                            <div class="checkbox">
                            ...
                            <div id="shadules" style="display: none">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="startdate" value="{{ $rss->startdate }}" />
                                </div>

                                <div class="form-group">
                                    <label class="control-label">End Date</label>
                                    <input type="date" class="form-control" name="enddate" value="{{ $rss->enddate }}"/>
                                </div>
