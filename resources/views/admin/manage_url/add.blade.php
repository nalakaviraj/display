...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-offset-2">
                        <h1 class="page-header">
                            Mange URL <small>Add New</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-info-circle"></i> Mange URL
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <form class="form-horizontal" action="{{ route('manage_url_store') }}" method="POST" enctype="multipart/form-data">
