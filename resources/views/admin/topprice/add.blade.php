        ...
        <div class="container-fluid">
            ...
            <!-- Page Heading -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-offset-2">
                        <h3 class="page-header {{ (Request::is('admin/pro_report/topprice/add/KVPL')) ?  'link-hightliter':'' }}"> <a href="{{ url('/admin/pro_report/topprice/add/KVPL') }}">KELANI VALLEY </a>
                        </h3>
                    </div>
                    <div class="col-lg-4">
                        <h3 class="page-header {{ (Request::is('admin/pro_report/topprice/add/TTEL')) ?  'link-hightliter':'' }}"> <a href="{{ url('/admin/pro_report/topprice/add/TTEL') }}">TALAWAKELLE</a>
                        </h3>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-offset-2">
                  ...
                  <form method="post" action="{{ url("/admin/pro_report/topprice/add") }}" >
                    ...
                    <div class="col-md-10">
                      ...
                      <table class="table table-condensed">
                          ...
                          <body>
                            @foreach ($topprice as $value)

                              <tr>
                                <form action="{{ url('/admin/pro_report/topprice/delete') }}" method="post" >
                              ...
                              <td>
                                  <a class="btn btn-primary" href="{{ url('/admin/pro_report/price/add') }}/top/{{$value->id}}" >Add price</a>
