        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <h1 style="margin-top: -125px;margin-left: 245px;font-weight: bold;" class="">BEST YPH RANK IMPROVEMENT -
                        <small style="color: #292929">ESTATE / DIVISION</small>
                    </h1>
                    <div class="col-lg-12" style="margin-bottom: 30px;">
                        <img src="{!! url('/assets/images/signage/temp_images/TTEL_Logo.png') !!}" style=" width: 200px;margin-left: 4%;margin-top: 50px;">
