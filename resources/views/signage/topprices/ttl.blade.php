    ...
    <body style="background-image: url('../../assets/images/signage/temp_images/sinage_background.png');background-repeat: no-repeat;height:100%; width:100%;background-size: 100%; background-color: #000;">
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                <h1 style="margin-top: -165px;margin-left: 245px;font-weight: bold;" class="">TOP PRICES
                    <br/><small style="color: #292929">ESTATE</small>
                </h1>
                <div class="col-lg-12" style="margin-bottom: 30px;">
                <img src="{!! url('/assets/images/signage/temp_images/TTEL_Logo.png') !!}" style=" width: 200px;margin-left: 4%;margin-top: 5%;  margin-bottom: 2.5%;">
                                    ...
                                    <div class="row">
                                        <div class="thumbnail" ><thead style="background-color: #bdbfbd;" >
                                            ...
                                            <div class="caption captions clearfix">
                                                <!--<table class="table table-bordered clearfix" style="margin-bottom: 0px; background-color: #ccc;" >-->
                                                <!--    <thead>-->
                                                <!--        <tr>-->
                                                <!--            <th style="text-align: center;width: 97px;">Tea</th>-->
                                                ...
                                                <div id="nt-example1-container" >
                                                    <ul class="nt-example1" id="nt-example1" style="padding-left: 0px;">
                                                        <?php $prices = App\Price::where('priceid',$value->id)->where('tablename', 'top')->get(); 
                                                        
                                                        foreach($prices as $price){
                                                            echo "<li>".$price->teatype.": Rs.".$price->price.".00</li>";
                                                        }
