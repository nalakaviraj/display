        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <h1 style="margin-top: -165px;margin-left: 245px;font-weight: bold;" class="">BEST IMPROVEMENT ON PROFIT PER HECTARE -
                        </br><small style="color: #292929">ESTATE / DIVISION</small>
                    </h1>
                    <div class="col-lg-12" style="margin-bottom: 30px;">
                        <img src="{!! url('/assets/images/signage/temp_images/TTEL_Logo.png') !!}" style=" width: 180px;margin-left: 4%;margin-top: 30px;">
                        <h2 style="margin-left: 46%;margin-top: -30px;font-weight: bold;"></h2>
                    </div>
                </div>
                <div class="col-lg-5">
