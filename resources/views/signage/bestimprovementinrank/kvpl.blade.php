        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <img src="{!! url('/assets/images/signage/temp_images/Hayleys_Logo.png') !!}" style=" width: 180px; margin-top: -165px;margin-left: 50px;">
                    <h1 style="margin-top: -127px;margin-left: 245px;font-weight: bold;" class="">BEST IMPROVEMENT IN VP RANK
                        <small style="color: #292929"></small>
                    </h1>
                    <div class="col-lg-12" style="margin-bottom: 0px;">
                        <img src="{!! url('/assets/images/signage/temp_images/KVPL_Logo.png') !!}" style=" width: 200px;margin-left: 4%;margin-top: 5%;margin-bottom: 5%">
                                ...
                                <div class="col-sm-6 ">
                                    <div class="row">
                                        <div class="thumbnail" >
                                            ...
                                            <?php if(!empty($dManager->employee_image_path_name)){ ?>
